package com.m4r71n.irshark.macro
...
class MacroEngine(private val context: Context) {
    ...
    fun launch(macro: SavedMacro, scope: CoroutineScope) {
        ...
        totalSteps  = com.m4r71n.irshark.data.countMacroSteps(macro.steps)
    ...
    private suspend fun executeStep(step: MacroStep): Boolean {
        ...
        return when (step) {
            ...
            is MacroStep.IfConfirm -> {
                ...
                totalSteps = flatStep + com.m4r71n.irshark.data.countMacroSteps(branch)
                pushProgress()
